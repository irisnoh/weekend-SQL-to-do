const pg = require('pg'); //bring in the thing that connects our DB
...
if (process.env.DATABASE_URL) {
  ...
  const params = url.parse(process.env.DATABASE_URL); //if we have a process.env.database_url use that (in heroku)
